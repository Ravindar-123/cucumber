...
public class LoginClass {
	...
	@Before
	public void open() {  //Hooks concept
		System.out.println("hai");
	}
	@After
	public void close() {  //Hooks concept
		System.out.println("bye");
	}
	@BeforeStep
	public void beforeStep() {  //Hooks concept
		System.out.println("iam before step");
	}
	@AfterStep
	public void afterStep() {  //Hooks concept
		System.out.println("iam after step");
	}
	...
	public void user_enter_username(String userdata) {
		WebElement usernamefield = driver.findElement(By.id("username"));
